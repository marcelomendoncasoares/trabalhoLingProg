...
// =============== COLOCAR TUDO ACIMA DESTA LINHA ANTES DA PARTE DE EXECUÇÃO DO CÓDIGO PRINCIPAL ===============

	string nomeArquivo = "./conversas/conversaAilma.txt";

	// Chamada da função em C++ que utiliza o código em Perl

	teste(nomeArquivo);


// ================== COLOCAR TUDO ABAIXO DESTA LINHA NO FINAL DO CÓDIGO, APÓS TODA EXECUÇÃO ===================
